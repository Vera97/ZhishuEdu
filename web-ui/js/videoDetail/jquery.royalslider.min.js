...
b.css(g);a._q3=f(b).find("."+e+"Container");
a._q6&&(e+="Arrow",c.arrowLeft?a._r6=c.arrowLeft:(a._r6=f('<div class="'+e+" "+e+'Left"><div class="'+e+'Icn"></div></div>'),b.append(a._r6)),c.arrowRight?a._s6=c.arrowRight:(a._s6=f('<div class="'+e+" "+e+'Right"><div class="'+e+'Icn"></div></div>'),b.append(a._s6)),a._r6.click(function(){var b=
(Math.floor(a._g3/a._t6)+a._u6)*a._t6;
a._y3(b>a._l3?a._l3:b)}),a._s6.click(function(){var b=(Math.floor(a._g3/a._t6)-a._u6)*a._t6;a._y3(b<a._m3?a._m3:b)}),c.arrowsAutoHide&&!a.hasTouch&&(a._r6.css("opacity",0),a._s6.css("opacity",0),b.one("mousemove.rsarrowshover",function(){a._l6&&(a._r6.css("opacity",1),a._s6.css("opacity",1))}),b.hover(function(){a._l6&&(a._r6.css("opacity",1),a._s6.css("opacity",1))},function(){a._l6&&(a._r6.css("opacity",0),a._s6.css("opacity",0))})));
a._k5=b;a._l5=a._q3.children();
...
a.ev.off("rsBeforeSizeSet.thumbs").on("rsBeforeSizeSet.thumbs",function(){a._w6=a._c3?a._a4:a._z3;
a.updateThumbsSize(!0)})},
        updateThumbsSize:function(){var a=this,e=a._l5.first(),c={},b=a._l5.length;
...
a.hasTouch&&a.st.thumbs.touch))a._m5=!0,a._k5.on(a._i1,function(b){a._f2(b,!0)});
        ...
        setThumbsOrientation:function(a,e){this._u3&&(this.st.thumbs.orientation=a,this._k5.remove(),this.slider.removeClass("rsWithThumbsHor rsWithThumbsVer"),this._k6(),this._k5.off(this._i1),e||this.updateSliderSize(!0))},
        _o3:function(a){this._g3=
a;this._d?this._q3.css(this._w1,this._x1+(this._c3?a+this._y1+0:0+this._y1+a)+this._z1):this._q3.css(this._c3?this._w1:this._v1,a)},
        _y3:function(a,e,c,b,g){var d=this;if(d._l6){e||(e=d.st.thumbs.transitionSpeed);
        d._g3=a;
        d._x6&&clearTimeout(d._x6);
        d._p6&&(d._d||d._q3.stop(),c=!0);var h={};d._p6=!0;
...
e,c?"easeOutCubic":d.st.easeInOut));
        b&&(d._g3=b);
        d._y6();
        d._x6=setTimeout(function(){d._p6=!1;g&&(d._y3(b,g,!0),g=null)},e)}},
        _y6:function(){this._q6&&(this._g3===this._l3?this._r6.addClass("rsThumbsArrowDisabled"):this._r6.removeClass("rsThumbsArrowDisabled"),this._g3===this._m3?this._s6.addClass("rsThumbsArrowDisabled"):this._s6.removeClass("rsThumbsArrowDisabled"))},
        _m6:function(a,e){var c=0,b,f=a*this._t6+2*this._t6-this._v6+this._l3,d=Math.floor(this._g3/this._t6);this._l6&&(this._j6&&(e=!0,
...
f.rsModules.thumbnails=f.rsProto._h6})(jQuery);
